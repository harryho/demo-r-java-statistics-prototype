/* 
 * $Id: RMAppEditorRuler.java,v 1.2 2008/04/25 14:43:40 gaudenz Exp $
 ...
 */
public class RMAppEditorRuler extends JComponent implements
		MouseMotionListener, DropTargetListener, PropertyChangeListener
{
	 ...
	 */
	protected double scale = RMAppDiagramPane.DEFAULT_PAGESCALE;

	/**
	 * Specifies the unit system. Default is
	 * {@link JGraphEditorDiagramPane#DEFAULT_ISMETRIC}.
	 */
	protected boolean isMetric = RMAppDiagramPane.DEFAULT_ISMETRIC;
	 ...
	 */
	public RMAppEditorRuler(JGraph graph, int orientation) {
